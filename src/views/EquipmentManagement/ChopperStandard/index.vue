<template>
  <div class="app-container">
    ...
    <div class="table">
      <el-table :data="chopperStandardList">
        <el-table-column
          prop="is_show"
          label="是否展示在首页"
        ></el-table-column>
...
import { getStandardList, createStandard } from "@/api/standarManagement";
import {} from ''
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async getSpectList() {
      ...
      this.chopperStandardList = res.data.list;
